...
ln -s /home/ruuffian/code/tooling/.dotfiles/.config/foot ~/.config/foot
ln -s /home/ruuffian/code/tooling/.dotfiles/.config/plasma-workspace ~/.config/plasma-workspace
touch .bash_local
touch ~/.bash_profile
echo ". ~/.bashrc" >> ~/.bash_profile
ln -s /home/ruuffian/code/tooling/.dotfiles/nvim-config ~/.config/nvim
ln -s /home/ruuffian/code/tooling/.dotfiles/.tmux.conf ~/.tmux.conf
